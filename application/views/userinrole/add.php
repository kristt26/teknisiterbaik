    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Userinrole Add</h3>
            </div>
            <?php echo form_open('userinrole/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="idrole" value="<?php echo $this->input->post('idrole'); ?>" class="form-control" id="idrole" />
						</div>
					</div>
				</div>
			</div>
